                  ...
                  <td>
                    <div className="btn-group">
                      ...
                      <ul role="menu" className="dropdown-menu" id="1_week">
                        <li><a id="red" href="#">Side walking</a></li>
                        <li><a id="red" href="#">Keep lifting</a></li>
                        <li><a id="red" href="#">Sit to stand</a></li>
                        <li><a id="red" href="#">Dynamic balance</a></li>
